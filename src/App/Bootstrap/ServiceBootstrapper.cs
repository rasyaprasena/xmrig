using Xmrig.App.Commands;
using Xmrig.ChainProviders.Evm;
using Xmrig.ChainProviders.Transport;
using Xmrig.ChainProviders.Utxo;
using Xmrig.Cryptography.Derivation;
using Xmrig.Cryptography.Vault;
using Xmrig.Engine.Analytics;
using Xmrig.Engine.Domain.Contracts;
using Xmrig.Engine.Networks;
using Xmrig.Engine.Options;
using Xmrig.Engine.Orchestration;
using Xmrig.Persistence.Stores;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;

namespace Xmrig.App.Bootstrap;
